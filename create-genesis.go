...
var localNetConfig = genesisConfig{
	...
	Deployers: []common.Address{
		common.HexToAddress("0xaB5e53D86C5116024Ba59C702D8Bd0C470A05Fd7"),
	},
	...
	SystemTreasury: map[common.Address]uint16{
		common.HexToAddress("0xaB5e53D86C5116024Ba59C702D8Bd0C470A05Fd7"): 10000,
	},
	...
	InitialStakes: map[common.Address]string{
		common.HexToAddress("0xaB5e53D86C5116024Ba59C702D8Bd0C470A05Fd7"): "0x3635c9adc5dea00000", // 1000 eth
	},
	// owner of the governance
	VotingPeriod: 20, // 1 minute
	// faucet
	Faucet: map[common.Address]string{
		common.HexToAddress("0xaB5e53D86C5116024Ba59C702D8Bd0C470A05Fd7"): "0x21e19e0c9bab2400000",
		common.HexToAddress("0x1cb0fFCc249715Be3E27d9A273317EAA051Ef1d9"): "0x21e19e0c9bab2400000",
		common.HexToAddress("0xf8C7E4E4442e1D34255335eE05832f9f20756Ac8"): "0x21e19e0c9bab2400000",
	},
}
...
var devNetConfig = genesisConfig{
	...
	Validators: []common.Address{
		common.HexToAddress("0x4A734892497A14B6900CB07621378FBE47ea27A2"),
	...
	InitialStakes: map[common.Address]string{
		common.HexToAddress("0x4A734892497A14B6900CB07621378FBE47ea27A2"): "0x3635c9adc5dea00000", // 1000 eth
	...
	// faucet
	Faucet: map[common.Address]string{
		common.HexToAddress("0xaB5e53D86C5116024Ba59C702D8Bd0C470A05Fd7"): "0x21e19e0c9bab2400000",    // governance
		common.HexToAddress("0xC97E8cc303dFaF912913655E30eD5605AE516b3e"): "0x52b7d2dcc80cd2e4000000", // faucet (10kk)
	},
}
